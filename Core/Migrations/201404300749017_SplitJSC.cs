namespace QOAM.Core.Migrations
{
    ...
    public partial class SplitJSC : DbMigration
    {
        public override void Up()
        {
            ...
            //RenameColumn(table: "dbo.ValuationQuestionScores", name: "ScoreCardId", newName: "ValuationScoreCardId");
            ...
            AddColumn("dbo.Institutions", "NumberOfBaseScoreCards", c => c.Int(nullable: false));
            AddColumn("dbo.Institutions", "NumberOfValuationScoreCards", c => c.Int(nullable: false));
            AddColumn("dbo.UserProfiles", "NumberOfBaseScoreCards", c => c.Int(nullable: false));
            AddColumn("dbo.UserProfiles", "NumberOfValuationScoreCards", c => c.Int(nullable: false));
            AddColumn("dbo.JournalScores", "NumberOfBaseReviewers", c => c.Int(nullable: false));
            ...
            DropColumn("dbo.JournalScores", "NumberOfReviewers");
        }
